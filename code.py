...
print(top_df.shape)
plt.bar(summer_df['Country_Name'],summer_df['Total_Summer'],width = 0.2)
plt.bar(winter_df['Country_Name'],winter_df['Total_Winter'],width = 0.2)
plt.bar(top_df['Country_Name'],top_df['Total_Medals'],width = 0.2)
...
print("Total Points scored by Best Country is: {}".format(most_points))
best_country = data_1.loc[data_1['Total_Points'].idxmax(),'Country_Name']
print("Top Country:", best_country, " with total points ",top_max_ratio )
